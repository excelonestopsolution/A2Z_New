...
import com.di_md.a2z.activity.login_id.forgot.ForgotLoginIdActivity
import com.di_md.a2z.activity.register.RegistrationActivity
import com.di_md.a2z.databinding.ActivityLogin2Binding
import com.di_md.a2z.util.*
import com.di_md.a2z.util.AppConstants.BASE_URL
...
class LoginActivity : AppCompatActivity(), InstallStateUpdatedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        APIs(
            BASE_URL, "userId", "token", "password", "ASKJHAU123SHYEWR", applicationContext
                .resources
