...
import com.di_md.a2z.adapter.DmtTransactionAdapter
import com.di_md.a2z.data.model.DmtTransactionDetail
import com.di_md.a2z.data.model.TransactionDetail
import com.di_md.a2z.databinding.ActivityDmtResponseBinding
...
@AndroidEntryPoint
class DmtTransactionResponseActivity : AppCompatActivity() {
    ...
    private fun setupListData(listData: List<DmtTransactionDetail>) {
        binding.recyclerView.setup().adapter = DmtTransactionAdapter().apply {
            this.context = this@DmtTransactionResponseActivity
            ...
            if (it) {
                ...
                if (serviceName.equals("dmt one", ignoreCase = true)) {
                    PdfHelper.downloadPdfData(
                        this@DmtTransactionResponseActivity,
