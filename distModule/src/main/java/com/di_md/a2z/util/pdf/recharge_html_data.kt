package com.di_md.a2z.util.pdf

import com.di_md.a2z.data.model.TransactionDetail
import com.di_md.a2z.util.CashUtil
import java.lang.StringBuilder

fun rechargeHtmlDataAsString(data : TransactionDetail) : String {
                                               ...
                                               <style>
                                                ...
                                                <table style="width: 100%; border: 1px solid #888;" >
                                                   <tr>
                                                       ...
                                                       <td style="text-align:center"> <b>Outlet Namze:${data.outletName}<br>Address: ${data.outletAddress}<br>Contact Number: ${data.outletNumber}</b></td>
                                                       <td> <img src="https://partners.a2zsuvidhaa.com/newlog/images/bbps_logo.jpg" style="width: 40px;"></td>
                                                </table>
                                               <table style="width: 100%; border: 1px solid #888;" >
                                                   ...
                                                   <tr style="border-top:1px solid #ddd;" id="trandetailbybps">
                                                       <td>
                                                           ...
                                                           <b class="cs" >Customer Mobile No :</b><span id="printCustomerNumber">${data.number}</span><br />
                                                       ...
                                                       <td colspan="3" style="padding: 0px;" >                                                   
                                                           ...
                                                           <div class="cs col-md-12 col-sm-12 col-xs-12">
                                                               ...
                                                               <label id="prt_tranword">
                                                                   ${CashUtil.doubleConvert(data.amount!!.toDouble())} 
                                                               </label>
                                                           </div>
                                                       </td>
                                                   </tr>  
