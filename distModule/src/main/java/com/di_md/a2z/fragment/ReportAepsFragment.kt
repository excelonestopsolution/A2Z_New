...
import com.di_md.a2z.adapter.AepsReportListAdapter
import com.di_md.a2z.data.model.TransactionDetail
import com.di_md.a2z.databinding.FragmentReportAepsBinding
import com.di_md.a2z.fragment.report.LedgerReportComponent
import com.di_md.a2z.fragment.report.ReportViewModel
...
import com.di_md.a2z.util.dialogs.AepsFilterDialog
                ...
                try {
                    ...
                    if (status == 1) {
                        ...
                        activity?.launchIntent(
                            AadharTransactionResponseActivity::class.java, bundleOf(
